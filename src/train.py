...
from utils import update_model, save_simple_metrics_reports, get_model_performance_test_set
...
logger.info('Separating dataset into train and test set')
...
params_tuning = {'core_model__n_estimators':range(20,301,20)}

grid_search = GridSearchCV(model,param_grid=params_tuning, scoring = 'r2', cv = 5)
...
save_simple_metrics_reports(train_score, test_score, validation_score, grid_search.best_estimator_)
